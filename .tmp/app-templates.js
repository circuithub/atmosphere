angular.module('templates-app', ['app/dashboard/controls.html', 'app/dashboard/dashboard.html', 'app/dashboard/drops.html', 'app/dashboard/status.html', 'app/graph/dev.html']);
...
angular.module("app/dashboard/status.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/dashboard/status.html",
    "<div ng-controller=\"StatusCtrl\"><p ng-repeat=\"(rainCloudID, rainCloud) in rainClouds\"><h3>{{rainCloudID}}</h3><h4>{{rainCloud}}</h4><br/><graph></graph></p></div>");
}]);
